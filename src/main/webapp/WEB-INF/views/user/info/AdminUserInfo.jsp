	 ...
	 $(function() {
		$("input:checkbox").on('click', function() {
			...
			$.ajax({
				...
				dataType: 'json',
				data: {id: , value:$('')},
				success: infoorganize				
			});
		});
	}); 
	var infoorganize = function(data) {
            ...
            <form>
              ...
              <hr>
	              ...
	              <label class="checkbox-inline ">
	                <input type="checkbox" name="optionsRadios" id="inlineCheckbox1" value="10"> 10대
	              </label>
	              <label class="checkbox-inline">
	                <input type="checkbox" name="optionsRadios" id="inlineCheckbox2" value="20"> 20대
	              </label>
	              <label class="checkbox-inline">
	                <input type="checkbox" name="optionsRadios" id="inlineCheckbox3" value="30"> 30대
	              </label>
	              <label class="checkbox-inline">
	                <input type="checkbox" name="optionsRadios" id="inlineCheckbox4" value="40"> 40대
	              </label>
	              <label class="checkbox-inline">
	                <input type="checkbox" name="optionsRadios" id="inlineCheckbox5" value="50"> 50대
	              </label>
                <hr>
                	 <label class="col-sm-2 col-sm-2 control-label">성별</label>
	              <label class="checkbox-inline ">
	                <input type="checkbox" name="optionsRadios2" id="inlineCheckbox1" value="W"><i class="fa fa-female"></i> 여성
	              </label>
	              <label class="checkbox-inline">
	                <input type="checkbox" name="optionsRadios2" id="inlineCheckbox2" value="M"><i class="fa fa-male"></i> 남성
	              </label>
              <hr>
              <br>
              </form>
