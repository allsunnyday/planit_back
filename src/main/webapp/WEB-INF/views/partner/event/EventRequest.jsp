            ...
            <section class="panel">
              <div class="panel-body">
                ...
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li><a href="<c:url value='/Planit/Admin/Event/List.do?'/>"> <i class="fa fa-inbox"></i> 진행중인 이벤트  <span class="label label-theme pull-right inbox-notification">${totalRecordCount }</span></a></li>
                  <li class="active"><a href="<c:url value="/Planit/Admin/Event/Request.do?"/>"> <i class="fa fa-envelope-o"></i> 이벤트 요청건</a></li>
                </ul>
              </div>
            </section>
