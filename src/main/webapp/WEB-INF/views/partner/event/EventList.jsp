...
// 	 // alert('ddd:'+$('#click_  last-child:li' ).serialize())
// 	  $.ajax({
// 		  url:'<c:url value="/Planit/Admin/Event/List.do"/>',
// 		  data:{status:$('#click_').val()},
// 		  dataType:'json',
// 		  success:function(data){
// 			  displayEvent(data,'#eventList')
// 		  }
...
// 	  });
//   });
//searchForm input:checked
//checklist
//  var displayEvent = function(data){
// 	 //
//  }  
