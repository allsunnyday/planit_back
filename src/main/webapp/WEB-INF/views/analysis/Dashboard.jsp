...
#ddddd{
    ...
    -webkit-border-radius: 20px;
       -moz-border-radius: 20px;
            border-radius: 20px;
    /* make it glow! */
    -webkit-box-shadow: 0px 0px 10px #DB8383;
       -moz-box-shadow: 0px 0px 10px #DB8383;
            box-shadow: 0px 0px 10px #DB8383; 
}
        ...
        <div class="row">
          <div class="col-lg-12 main-chart">
            ...
            <div class="border-head">
              <h3>PLANIT 가입자 >> <span style="color:red; font-size:2em;">${memberCount }</span> 명</h3>
            </div>
            </br>
            <div class="col-md-4col-sm-4 custom-bar-chart" style="margin-left:40px">
                <ul class="y-axis">
                <li><span>100</span></li>
                <li><span>80</span></li>
                <li><span>60</span></li>
              ...
              <div class="bar">
                ...
                <div class="value tooltips" data-original-title="${male }명" data-toggle="tooltip" data-placement="top">${male}%</div>
              </div>
              <div class="bar">
                <div class="title" style="font-size:1em">WOMAN</div>
                <div class="value tooltips" data-original-title="${female }명" data-toggle="tooltip" data-placement="top">${female}%</div>
              </div>
...
<!--               </div> -->
            ...
            <div class="col-md-12 col-sm-6 mb" >
                <div class="col-sm-1 ">
                </div>
               ...
               <div class="col-sm-5  ">
                 	<div id="dddd"class="weather pn">
	                  	<a href="<c:url value='/Planit/Admin/BBS/AskList.do'/>">
                  ...
                  <div class="badge badge-hot">HOT</div>
                 	 <img src="data:image/png;base64," width="235" alt="">
                  			<c:forEach var="record" items="${hotPlanner}">
                  				<h4 class="mt">가장 많이 이용하는 유저&nbsp;:&nbsp;${record.id}</h4>
...
<!--                   			<button class="btn btn-small btn-theme04">FULL REPORT</button> -->
    ...
    <script>
      ...
      function drawChart() {
        ...
        var options = {'title':'PLANNER로 보는 사용자들이 직접 다니는 관광지 비율',
                       'width':800,
                       'height':400,
